$packageRepo = '{{SITE_URL}}/api/v2/'
$repoUsername = '{{SITE_USER}}'    # this must be empty is NOT using authentication
$repoPassword = '{{SITE_PASSWORD}}'    # this must be empty if NOT using authentication
